...
export function createWebviewSchema(schemaName: string, json: any) {
	// Creates the window which the webview will be displayed in
	let panel: vscode.WebviewPanel | undefined = undefined;
	panel = vscode.window.createWebviewPanel(
		'schemaView', // Identifies the type of the webview. Used internally
...
export function createWebviewTypeside(typesideName: string, json: any) {
	// Creates the window which the webview will be displayed in
	let panel: vscode.WebviewPanel | undefined = undefined;
	panel = vscode.window.createWebviewPanel(
		'typesideView', // Identifies the type of the webview. Used internally
...
function getWebviewContent(title: string, data, physics) {
	return `
	<!doctype html>
	<html>
	<head>
