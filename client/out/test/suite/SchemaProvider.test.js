...
const SchemaProvider_1 = require("../../cql/treeview/SchemaProvider");
const mocha_1 = require("mocha");
suite('SchemaProvider Test Suite', () => {
    vscode.window.showInformationMessage('Start all tests.');
    let s;
    mocha_1.beforeEach('create the schema provider', () => {
        s = new SchemaProvider_1.SchemaProvider();
    });
    // getSchemas Tests
    ...
    test('getSchemas error when given data without schemas', () => {
        ...
        assert.throws(() => { s.getSchemas(data); }, new Error("Schemas not found."));
    });
    ...
    test('getAttributes error when given data without attributes', () => {
        ...
        assert.throws(() => { s.getAttributes(data); }, new Error("Attributes not found."));
    });
    ...
    test('getEntities error when given data without entities', () => {
        ...
        assert.throws(() => { s.getEntities(data); }, new Error("Entities not found."));
    });
    ...
    test('getForeignKeys error when given data without foreign keys', () => {
        ...
        assert.throws(() => { s.getForeignKeys(data); }, new Error("ForeignKeys not found."));
    });
...
//# sourceMappingURL=SchemaProvider.test.js.map